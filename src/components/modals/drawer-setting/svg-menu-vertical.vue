  ...
  <svg fill="none" height="66" width="104" xmlns="http://www.w3.org/2000/svg">
    <g>
      ...
      <path id="svg_2"
        ...
        fill="var(--el-color-primary)" stroke="null"></path>
      ...
      <path id="svg_5"
        ...
        fill="#ffffff" opacity="undefined"></path>
