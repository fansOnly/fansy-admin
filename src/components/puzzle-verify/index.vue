<template>
  <div class="puzzle-verify" :style="{ width: props.width + 32 + 'px' }">
    <div class="puzzle-verify-box">
      <div class="puzzle-buttons">
        <div class="puzzle-button" :style="{color}" @click="onReset()">
          <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24">
            <path d="M983.480349 307.199781A512.950491 512.950491 0 0 0 513.318399 0a512.365348 512.365348 0 0 0-410.843135 205.531282 42.422827 42.422827 0 0 0 67.80338 50.687964 427.66598 427.66598 0 0 1 343.039755-171.666164 428.251123 428.251123 0 0 1 392.557434 256.438674 42.422827 42.422827 0 0 0 77.604516-33.865118zM34.379313 332.799762A334.55519 334.55519 0 0 0 0.002194 469.869379a42.276541 42.276541 0 0 0 84.699368 0.877713 251.611249 251.611249 0 0 1 24.795411-99.035358A42.422827 42.422827 0 0 0 34.379313 332.799762z m10.166849 387.144867A512.950491 512.950491 0 0 0 513.318399 1023.999269a512.365348 512.365348 0 0 0 410.404278-204.872997 42.422827 42.422827 0 0 0-67.730237-50.761107 427.66598 427.66598 0 0 1-342.674041 171.081021 428.251123 428.251123 0 0 1-391.387149-253.805533 42.422827 42.422827 0 0 0-77.385088 34.377118z m948.954751-24.575983c21.284556-43.885683 30.866264-89.96565 30.50055-142.628469a42.276541 42.276541 0 0 0-84.699368 0.731428c0.292571 40.009114-6.582852 73.362233-21.942842 105.033067a42.422827 42.422827 0 0 0 76.214803 36.937117z" fill="currentColor" p-id="7603"></path>
            <path d="M776.632497 276.333517A44.982825 44.982825 0 0 0 731.430243 321.096914c0 24.649125 20.260557 44.690254 45.202254 44.690253h177.005588A69.924521 69.924521 0 0 0 1024.001463 296.22836V117.759916a44.982825 44.982825 0 0 0-45.202254-44.617111 44.982825 44.982825 0 0 0-45.275396 44.617111v158.573601h-156.891316zM247.37116 747.665752A44.982825 44.982825 0 0 0 292.573414 702.902355 44.982825 44.982825 0 0 0 247.37116 658.285244H70.365573A69.924521 69.924521 0 0 0 0.002194 727.770909v178.468444c0 24.575982 20.260557 44.617111 45.202254 44.617111a44.982825 44.982825 0 0 0 45.275396-44.617111v-158.573601h156.891316z" fill="currentColor" p-id="7604"></path>
          </svg>
        </div>
      </div>
      <div v-show="loading" class="puzzle-loading-mask">
        <svg class="puzzle-loading-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
      ...
      <div class="puzzle-verify-state" :class="{'is-fail': verifyStatus === 2, 'is-hide': verifyStatus === 0 }">{{ verifyStatus === 1 ? successText : failText }}</div>
    </div>
    <div v-if="initialized" class="puzzle-slider-bar">
      ...
      <div class="slider-bar-block" :style="{ left: position + 'px', color }" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" @mousedown="onMouseDown">
        <svg v-if="moving" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30">
          <path d="M170.666667 128a42.666667 42.666667 0 0 0-42.666667 42.666667v682.666666a42.666667 42.666667 0 0 0 42.666667 42.666667h682.666666a42.666667 42.666667 0 0 0 42.666667-42.666667V170.666667a42.666667 42.666667 0 0 0-42.666667-42.666667H170.666667z m256 213.333333v128h170.666666V341.333333l170.666667 170.666667-170.666667 170.666667v-128h-170.666666v128l-170.666667-170.666667 170.666667-170.666667z" fill="currentColor" p-id="5781"></path>
        </svg>
        <svg v-else viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24">
          <path d="M128.7 128.7m63.7 0l0 0q63.7 0 63.7 63.7l0 639.55q0 63.7-63.7 63.7l0 0q-63.7 0-63.7-63.7l0-639.55q0-63.7 63.7-63.7Z" fill="currentColor" p-id="12434"></path>
          <path d="M768.5 128.7m63.7 0l0 0q63.7 0 63.7 63.7l0 639.55q0 63.7-63.7 63.7l0 0q-63.7 0-63.7-63.7l0-639.55q0-63.7 63.7-63.7Z" fill="currentColor" p-id="12435"></path>
          <path d="M448.6 128.7m63.7 0l0 0q63.7 0 63.7 63.7l0 639.55q0 63.7-63.7 63.7l0 0q-63.7 0-63.7-63.7l0-639.55q0-63.7 63.7-63.7Z" fill="currentColor" p-id="12436"></path>
        </svg>
      </div>
    </div>
  </div>
